---
title: JavaScript/Go SDK changelog
description: User-facing updates, features, enhancements, and fixes to the Modal JavaScript and Go client libraries.
---
...
<Note>
The first **beta release** of the Modal SDKs for JS and Go (graduating from alpha). See the [Migration Guide](/migration/v05-migration-guide) for a detailed list of breaking changes.
</Note>
...
- Added support for [Named Sandboxes](https://modal.com/docs/guide/sandbox#named-sandboxes)
