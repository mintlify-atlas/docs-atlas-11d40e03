...
<Note>
Functions and classes are the main objects you register with an App. Learn more in the [Functions](/concepts/functions) and [Classes](/concepts/classes) documentation.
</Note>
